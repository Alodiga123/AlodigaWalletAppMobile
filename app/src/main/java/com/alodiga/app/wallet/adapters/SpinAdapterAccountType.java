...
public class SpinAdapterAccountType extends ArrayAdapter<ObjGenericObject> {

    private Context context;
    private ObjGenericObject[] values;

    public SpinAdapterAccountType(@NonNull Context context, @LayoutRes int resource, @NonNull ObjGenericObject[] values) {
