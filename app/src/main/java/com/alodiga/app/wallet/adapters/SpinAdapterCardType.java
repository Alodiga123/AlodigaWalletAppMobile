...
public class SpinAdapterCardType extends ArrayAdapter<ObjCreditCardTypeId> {
    ...
    private ObjCreditCardTypeId[] values;

    public SpinAdapterCardType(@NonNull Context context, @LayoutRes int resource, @NonNull ObjCreditCardTypeId[] values) {
    ...
    public ObjCreditCardTypeId getItem(int position) {
