...
private ObjCountry[] values;

public SpinAdapterCountry(@NonNull Context context, @LayoutRes int resource, @NonNull ObjCountry[] values) {
...
public ObjCountry getItem(int position){ return values[position]; }
