...
public class SpinAdapterDocumentType extends ArrayAdapter<ObjDocumentType> {

    private Context context;
    private ObjDocumentType[] values;

    public SpinAdapterDocumentType(@NonNull Context context, @LayoutRes int resource, @NonNull ObjDocumentType[] values) {
    ...
    public ObjDocumentType getItem(int position) {
