...
public class SpinAdapterGeneric extends ArrayAdapter<ObjGenericObject> {

    private Context context;
    private ObjGenericObject[] values;

    public SpinAdapterGeneric(@NonNull Context context, @LayoutRes int resource, @NonNull ObjGenericObject[] values) {
