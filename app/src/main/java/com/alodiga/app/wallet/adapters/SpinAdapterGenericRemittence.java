...
public class SpinAdapterGenericRemittence extends ArrayAdapter<ObjGenericObject> {

    private Context context;
    private ObjGenericObject[] values;

    public SpinAdapterGenericRemittence(@NonNull Context context, @LayoutRes int resource, @NonNull ObjGenericObject[] values) {
