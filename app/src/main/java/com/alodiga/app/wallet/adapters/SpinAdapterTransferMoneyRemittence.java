...
public class SpinAdapterTransferMoneyRemittence extends ArrayAdapter<ObjTransferMoney> {

    private Context context;
    private ObjTransferMoney[] values;

    public SpinAdapterTransferMoneyRemittence(@NonNull Context context, @LayoutRes int resource, @NonNull ObjTransferMoney[] values) {
