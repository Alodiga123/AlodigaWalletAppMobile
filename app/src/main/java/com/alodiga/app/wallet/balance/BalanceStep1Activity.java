...
public class BalanceStep1Activity extends AppCompatActivity {
    ...
    UserGetCheckBalance mAuthTask_S;
    ...
    public void checkBalance(){
        ...
        mAuthTask_S = new UserGetCheckBalance();
    ...
    public class UserGetCheckBalance extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                map.put("card", Session.getCardBalance());
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                String balance_ = res_.getProperty("balance").toString();
                String accountNumber = res_.getProperty("accountNumber").toString();



                cardnumber.setText(Session.getCardBalance());
