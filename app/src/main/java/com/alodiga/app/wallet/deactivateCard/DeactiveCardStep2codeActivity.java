...
public class DeactiveCardStep2codeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        step1_next_button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (getCode.equals("") || getCode.length() == 0 || getCode.length() != 4) {
                    ...
                    Intent i = new Intent(DeactiveCardStep2codeActivity.this, FailCodeOperationActivity.class);
                    finish();
                    startActivity(i);
                } else {
        ...
        backToLoginBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(DeactiveCardStep2codeActivity.this, DeactiveCardActivity.class);
                startActivity(i);
                finish();
    ...
    public class UserGetProcessActive extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                map.put("card", Session.getCardDeactive());
