...
import com.alodiga.app.wallet.register.RegisterStep3Fragment;
...
public class ForgotPasswordStep2Fragment extends Fragment implements
        OnClickListener {
    ...
    public ForgotPasswordStep2Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.forgotpassword_step2_layout, container,
                false);
        initViews();
        setListeners();
        ...
        switch (v.getId()) {
            case R.id.backToLoginBtn:
                getFragmentManager()
                        ...
                        .replace(R.id.frameContainer, new ForgotPasswordStep1Fragment(),

                                //Utils.RegisterStep4WelcomeFragment).commit();
                                Utils.ForgotPasswordStep1_Fragment).commit();
                break;
    ...
    private void submitButtonTask() {
        ...
        if (getMobileCode.equals("") || getMobileCode.length() == 0)
            ...
            if (!getMobileCode.equals(Session.getMobileCodeSms())) {
                ...
                Intent show;
                show = new Intent(getContext(), ForgotPasswordStep3Activity.class);
                startActivity(show);
