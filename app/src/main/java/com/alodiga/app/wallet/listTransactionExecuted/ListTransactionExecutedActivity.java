package com.alodiga.app.wallet.listTransactionExecuted;
...
import static com.alodiga.app.wallet.duallibrary.listTransactionExecuted.ListTransactionExecutedController.getParseResponse;
import static com.alodiga.app.wallet.duallibrary.listTransactionExecuted.ListTransactionExecutedController.getTransactionExecuted;
...
public class ListTransactionExecutedActivity extends AppCompatActivity implements OnItemSelectedListener {
    ...
    public class TransferOfFunds extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try{
                SoapObject response = getTransactionExecuted();
