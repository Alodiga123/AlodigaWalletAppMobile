...
public class RechargeMyCardStep4Activity extends AppCompatActivity {
    ...
    public RechargeMyCardStep4Activity() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recharge_my_wallet_confirmation_succesfull);
        ...
        btnProcessFinisTransference.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                //updateProduct();
                Intent i = new Intent(RechargeMyCardStep4Activity.this, MainActivity.class);
    ...
    public void onBackPressed() {
        Intent show = new Intent(RechargeMyCardStep4Activity.this, MainActivity.class);
        finish();
        startActivity(show);
