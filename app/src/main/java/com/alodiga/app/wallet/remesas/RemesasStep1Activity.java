...
public class RemesasStep1Activity extends AppCompatActivity {
    ...
    private RemesasStep1Activity.FindUserTask mAuthTask = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.remesas_step1_layout);
            ...
            public void onClick(View v) {
                ...
                if (checkValidation()) {
                    ...
                    if (caseFind.equals(2)) {
                        Session.setMoneySelected(currencySelected);
                        Intent i = new Intent(RemesasStep1Activity.this, RemesasStep2QrActivity.class);
                        startActivity(i);
                        finish();
        ...
        backToLoginBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(RemesasStep1Activity.this, MainActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public class FindUserTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent i = new Intent(RemesasStep1Activity.this, RemesasStep3Activity.class);
                startActivity(i);
                finish();
