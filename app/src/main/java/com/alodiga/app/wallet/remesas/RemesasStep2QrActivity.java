...
public class RemesasStep2QrActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    private RemesasStep2QrActivity.FindUserTask mAuthTask = null;
    ...
    public void handleResult(Result rawResult) {
        ...
        try {
            ...
            if (emailFind.equals(Session.getEmail())) {
                Intent i = new Intent(RemesasStep2QrActivity.this, RemesasStep1Activity.class);
                startActivity(i);
                finish();
                ...
                mAuthTask = new RemesasStep2QrActivity.FindUserTask(emailFind);
            ...
            Intent i = new Intent(RemesasStep2QrActivity.this, MainActivity.class);
            startActivity(i);
            finish();
            e.printStackTrace();
        }
    ...
    public class FindUserTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent i = new Intent(RemesasStep2QrActivity.this, RemesasStep3Activity.class);
                startActivity(i);
                finish();
            } else {
                new CustomToast().Show_Toast(getApplicationContext(), getWindow().getDecorView().getRootView(),
