...
public class RemesasStep4codeActivity extends AppCompatActivity {
    static int cout = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.remesas_step4_code_layout);
        ...
        step1_next_button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (getCode.equals("") || getCode.length() == 0 || getCode.length() != 4) {
                    ...
                    Intent i = new Intent(RemesasStep4codeActivity.this, FailCodeOperationActivity.class);
                    finish();
                    startActivity(i);
                } else {
        ...
        backToLoginBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(RemesasStep4codeActivity.this, RemesasStep3Activity.class);
                finish();
                startActivity(i);
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                if (cout <= 3) {
                    ...
                    Intent i = new Intent(RemesasStep4codeActivity.this, RemesasStep5Activity.class);
                    startActivity(i);
                    finish();
                } else {
                    Intent i = new Intent(RemesasStep4codeActivity.this, FailCodeOperationActivity.class);
