...
public class RemesasStep6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.remesas_step6_succesfull_layout);
        ...
        btnProcessFinisTransference.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                //updateProduct();
                Intent i = new Intent(RemesasStep6Activity.this, MainActivity.class);
    ...
    public void onBackPressed() {
        Intent show = new Intent(RemesasStep6Activity.this, MainActivity.class);
        finish();
        startActivity(show);
