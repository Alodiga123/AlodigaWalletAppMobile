...
public class TransferenceStep5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.transference_confirmation_transfer2);
    ...
    protected ArrayList<ObjUserHasProduct> getListProduct(SoapObject response) {
        ...
        for (int i = 4; i < response.getPropertyCount(); i++) {
            ...
            ObjUserHasProduct object = new ObjUserHasProduct(obj.getProperty("id").toString(), obj.getProperty("name").toString(), obj.getProperty("currentBalance").toString(), obj.getProperty("symbol").toString(), obj.getProperty("isPayTopUp").toString(),toString(), obj.getProperty("isPayTopUp").toString(),obj.getProperty("isUsePrepaidCard").toString());
