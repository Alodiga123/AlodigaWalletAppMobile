...
public class TransferenceCardToCArdStep6Activity extends AppCompatActivity {
    ...
    public TransferenceCardToCArdStep6Activity() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.transferencecardtocardstep6_layout);
        ...
        btnProcessFinisTransference.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                //updateProduct();
                Intent i = new Intent(TransferenceCardToCArdStep6Activity.this, MainActivity.class);
    ...
    public void onBackPressed() {
        Intent show = new Intent(TransferenceCardToCArdStep6Activity.this, MainActivity.class);
        finish();
        startActivity(show);
