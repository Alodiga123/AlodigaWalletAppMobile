...
public class TransferenceCardToCardStep2QrActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    private TransferenceCardToCardStep2QrActivity.FindUserTask mAuthTask = null;
    ...
    public void handleResult(Result rawResult) {
        ...
        try {
            ...
            if (emailFind.equals(Session.getEmail())) {
                ...
                mAuthTask = new TransferenceCardToCardStep2QrActivity.FindUserTask(emailFind);
    ...
    public class FindUserTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent i = new Intent(TransferenceCardToCardStep2QrActivity.this, TransferenceCardToCardStep3Activity.class);
                startActivity(i);
                finish();
            } else {
                new CustomToast().Show_Toast(getApplicationContext(), getWindow().getDecorView().getRootView(),
