...
import static com.alodiga.app.wallet.duallibrary.transferenceCardToCard.TransferenceCardToCardController.validCode;

public class TransferenceCardToCardStep4codeActivity extends AppCompatActivity {
    static int cout = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.transferencecardtocardstep4_code_layout);
        ...
        step1_next_button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (getCode.equals("") || getCode.length() == 0 || getCode.length() != 4) {
                    ...
                    Intent i = new Intent(TransferenceCardToCardStep4codeActivity.this, FailCodeOperationActivity.class);
                    finish();
                    startActivity(i);
                } else {
        ...
        backToLoginBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(TransferenceCardToCardStep4codeActivity.this, TransferenceCardToCardStep3Activity.class);
                finish();
                startActivity(i);
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                if (cout <= 3) {
                    ...
                    Intent i = new Intent(TransferenceCardToCardStep4codeActivity.this, TransferenceCardToCardStep5Activity.class);
                    startActivity(i);
                    finish();
                } else {
                    Intent i = new Intent(TransferenceCardToCardStep4codeActivity.this, FailCodeOperationActivity.class);
