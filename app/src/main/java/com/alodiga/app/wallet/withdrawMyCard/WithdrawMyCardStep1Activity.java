...
public class WithdrawMyCardStep1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signFind.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent i = new Intent(WithdrawMyCardStep1Activity.this, WithdrawMyCardStep2codeActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        backToLoginBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(WithdrawMyCardStep1Activity.this, MainActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public class FindUserTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent i = new Intent(WithdrawMyCardStep1Activity.this, TransferenceStep3Activity.class);
                startActivity(i);
                finish();
