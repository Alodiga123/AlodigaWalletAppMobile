...
public class WithdrawMyCardStep3Activity extends AppCompatActivity {
    ...
    private static TextView txtConceptValue_2, txtAmountValue_2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnProcessTransaction.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                mAuthTask = new WithdrawMyCardStep3Activity.ProcessOperationRechargeWalletTask(Session.getEmail(), Session.getMoneySelected().getId(), Session.getGetDestinationAmount());
