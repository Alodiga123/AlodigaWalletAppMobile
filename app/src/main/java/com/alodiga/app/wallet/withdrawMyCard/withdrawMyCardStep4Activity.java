...
public class withdrawMyCardStep4Activity extends AppCompatActivity {
    private static TextView amountValue, conceptValue;
    private static TextView txtTransactionId_3, txtAccountSourceValue, txtDateTimeValue_3, txtAmountValue, txtConceptValue;
    ...
    public withdrawMyCardStep4Activity() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.withdraw_my_wallet_confirmation_succesfull);
        ...
        btnProcessFinisTransference.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                //updateProduct();
                Intent i = new Intent(withdrawMyCardStep4Activity.this, MainActivity.class);
    ...
    public void onBackPressed() {
        Intent show = new Intent(withdrawMyCardStep4Activity.this, MainActivity.class);
        finish();
        startActivity(show);
