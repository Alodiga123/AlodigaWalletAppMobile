...
public class Confirmation2_Activity_Comerce extends AppCompatActivity {
	...
	public Confirmation2_Activity_Comerce() {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.confirmation_transfer2_comerce);
	...
	public class ProcessOperationTransferenceTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPostExecute(final Boolean success) {
			...
			if (success) {
				...
				Intent i = new Intent(Confirmation2_Activity_Comerce.this, Confirmation3_Activity_Comerce.class);
				startActivity(i);
				finish();
			} else {
