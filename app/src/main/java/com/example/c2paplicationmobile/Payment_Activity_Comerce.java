...
public class Payment_Activity_Comerce extends AppCompatActivity {
    ...
    private Payment_Activity_Comerce.FindUserTask mAuthTask = null;
    ...
    public class FindUserTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent i = new Intent(Payment_Activity_Comerce.this, Confirmation1_Activity.class);
                startActivity(i);
                finish();
