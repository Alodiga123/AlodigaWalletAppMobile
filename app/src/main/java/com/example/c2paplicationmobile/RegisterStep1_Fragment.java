...
public class RegisterStep1_Fragment extends Fragment implements
	...
	private RegisterStep1_Fragment.UserSendSmsTask mAuthTask = null;

	public RegisterStep1_Fragment() {
	...
	private void initViews() {
		phoneNumber = (EditText) view.findViewById(R.id.mobileNumberRegister);
