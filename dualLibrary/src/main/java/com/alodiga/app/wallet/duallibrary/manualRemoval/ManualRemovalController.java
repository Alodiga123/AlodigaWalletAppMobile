package com.alodiga.app.wallet.duallibrary.manualRemoval;
...
public class ManualRemovalController {
    ...
    public static SoapObject removalAction(ObjGenericObject getbank, ObjTransferMoney getproduct, String getaccountBank , String getDescrip, String getAmountRecharge){
            ...
            return WebService.invokeGetAutoConfigString(map, Constants.WEB_SERVICES_METHOD_NAME_REMOVAL_MANUAL, Constants.ALODIGA);
        }
}
